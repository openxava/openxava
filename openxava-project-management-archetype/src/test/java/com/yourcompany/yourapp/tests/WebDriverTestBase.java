...
abstract public class WebDriverTestBase extends TestCase {
	...
	protected void executeWithoutArg(String moduleName, String action) throws Exception {
		...
		WebElement button = driver.findElement
				(By.id("ox_yourapp_" + moduleName + "__" + actionS[0] + "___" + actionS[1]));
		button.click();
	...
	protected void executeWithArg(String moduleName, String action, String arguments) throws Exception { 
		try { 
			...
			WebElement button = driver.findElement(By.id("ox_yourapp_" + moduleName + "__" + action + "___" + arguments));
			button.click();
		}
		acceptInDialogJS(driver);
		wait(driver);
	...
	protected void goModule(String module) throws Exception {
		this.module = module;
		driver.get("http://localhost:8080/yourapp/modules/" + module);
		wait(driver);
		acceptInDialogJS(driver);
	}
	...
	protected void moveToListView() throws Exception {
		try {
			WebElement button = driver.findElement(By.id("ox_yourapp_" + module + "__Mode___list"));
			button.click();
			wait(driver);
		}
		catch (Exception ex) {
	...
	protected int getListColumnCount() throws Exception {
		return driver.findElements(By.cssSelector("#ox_yourapp_" + module + "__list_core .xava_view_list_header th")).size();
	}
	...
	protected int getCollectionColumnCount(String collection) throws Exception {
		return driver.findElements(By.cssSelector("#" + Ids.decorate("yourapp", module, collection) + " .xava_view_list_header th")).size();
	}
	...
	protected int getListRowCount() throws Exception {
		return driver.findElements(By.cssSelector("#ox_yourapp_" + module + "__list_core .ox-list-row")).size();
	}
	...
	protected int getCollectionRowCount(String collection) throws Exception {
		return driver.findElements(By.cssSelector("#" + Ids.decorate("yourapp", module, collection) + " .ox-list-row")).size();
	}
	...
	protected String getValueInList(int row, int column) throws Exception {
		return driver.findElement(By.cssSelector("#ox_yourapp_" + module + "__list_core .ox-list-row:nth-child(" + (row + 1) + ") td:nth-child(" + (column + 1) + ")")).getText().trim();
	}
	...
	protected String getValueInCollection(String collection, int row, int column) throws Exception {
		return driver.findElement(By.cssSelector("#" + Ids.decorate("yourapp", module, collection) + " .ox-list-row:nth-child(" + (row + 1) + ") td:nth-child(" + (column + 1) + ")")).getText().trim();
	}
	
	protected void assertNoEditable(String name) throws Exception {
		WebElement element = driver.findElement(By.id(Ids.decorate("yourapp", module, name)));
	...
	protected void assertValidValues(String name, String [][] values) throws Exception {
		WebElement select = driver.findElement(By.id(Ids.decorate("yourapp", module, name)));
	...
	protected String getDescriptionValue(String name) {		
		WebElement input = driver.findElement(By.name(Ids.decorate("yourapp", module, name + "__DESCRIPTION__")));
	...
	protected String getValue(String name) {
		WebElement input = driver.findElement(By.id(Ids.decorate("yourapp", module, name)));
		return input.getAttribute("value");
	}
	...
	protected void assertNoErrors() {
		WebElement errors = driver.findElement(By.id("ox_yourapp_" + module + "__errors"));
	...
	protected void clearListCondition() throws Exception{
		driver.findElement(By.id("ox_yourapp_" +  module + "__xava_clear_condition")).click();
		wait(driver);
	}

	protected void setConditionValue(String value, int column) {
		driver.findElement(By.id("ox_yourapp_" + module + "__conditionValue___" + String.valueOf(column))).sendKeys(value); 		
	}
	
	protected void setConditionComparator(String value, int column) throws Exception {
		WebElement selectCondition = driver.findElement(By.id("ox_yourapp_" + module + "__conditionComparator___" + String.valueOf(column)));
	...
	protected void login(String user, String password) throws Exception {
		WebElement userField = driver.findElement(By.id("ox_yourapp_SignIn__user"));
		userField.sendKeys(user);
		WebElement passwordField = driver.findElement(By.id("ox_yourapp_SignIn__password"));
		passwordField.sendKeys(password);
		
		WebElement loginButton = driver.findElement(By.id("ox_yourapp_SignIn__SignIn___signIn"));
		loginButton.click();
		wait(driver);
	}
