...
console.log("[execute] scriptName=" + scriptName);
console.log("[execute] methodName=" + methodName);
...
if (script.includes('handleCallback("0"')) {
	...
	console.log("[executeScript] json.1=" + json); // tmr
	...
	var paramsString = script.substring(functionCallIndex + 10, jsonIndex);
	...
	dwr.engine.remote.handleCallback(param1,param2,response); 
...
batch.reply = reply;
console.log("[handleCallback] reply=" + reply); // tmr
var propiedades = Object.keys(reply); // TMR ME QUEDÉ POR AQUÍ: ESTO PUEDE SER LA CLAVE ES UN OBJETO CON LAS PROPIEDADES, PUEDE QUE NI TENGA QUE CONVERTIRLO
console.log("[handleCallback] reply.propiedades=" + propiedades); // tmr
...
console.log("[handleCallback] handlers.callbackArg=" + handlers.callbackArg); // tmr
...
console.log("[stateChange] reply=" + reply); // tmr
