...
public class ModuleManager implements java.io.Serializable {
	...
	private void trackAction(MetaAction metaAction, View view) { 
		...
		if (Is.anyEqual(controllerName,
				...
				"Chart", "Mode", "Calendar", "List",
				"ChangeListConfiguration", "SaveListConfiguration",
				"ChangeColumnName", "Cards", "ListFormat", "NoCustomizeList", 
				"AddColumns", "Reference", "NewCreation", "Modification", 
				"ReferenceSearch", "AddToCollection", "Collection", 
				"CollectionTotals", "CollectionCopyPaste", "ElementCollection", 
				"ManyToMany", "ManyToManyNewElement", "ManyToManyUpdateElement", 	
	...
	public void preInitModule(HttpServletRequest request) { 
		...
		if (modelCodeVersion < Hotswap.getModelVersion()) {
            System.out.println("ModuleManager.preInitModule() - modelCodeVersion < Hotswap.getModelVersion() - Reloading meta model");
        ...
        if (controllersCodeVersion < Hotswap.getControllersVersion()) {
            System.out.println("ModuleManager.preInitModule() - controllersCodeVersion < Hotswap.getControllersVersion() - Resetting module controllers");
        	metaModule = null;
        	setupModuleControllers();
