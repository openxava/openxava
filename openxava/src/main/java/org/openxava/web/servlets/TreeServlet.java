...
/**
 * Servlet for Tree operations.
 * 
 * @author Javier Paniza
 * @since 8.0
 */
@WebServlet(name = "tree", urlPatterns = "/xava/tree")
public class TreeServlet extends BaseServlet {

    private static final long serialVersionUID = 1L;
    private static Log log = LogFactory.getLog(TreeServlet.class);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            switch (operation) {
                case "getNodes" -> handleGetNodes(request, response, application, module);
                case "updateNode" -> handleUpdateNode(request, response, application, module);
            ...
            log.error("Error processing tree operation: " + operation, e);
    ...
    private void handleGetNodes(HttpServletRequest request, HttpServletResponse response, String application, String module) throws Exception {
        String collectionName = request.getParameter("collectionName");
        String collectionViewParentName = request.getParameter("collectionViewParentName");
        if (collectionViewParentName == null) collectionViewParentName = "";
    ...
    private void handleUpdateNode(HttpServletRequest request, HttpServletResponse response, String application, String module) throws Exception {
        String collectionName = request.getParameter("collectionName");
        String collectionViewParentName = request.getParameter("collectionViewParentName");
        if (collectionViewParentName == null) collectionViewParentName = "";
        ...
        String[] rowsParam = request.getParameterValues("rows");
        List<String> rows = rowsParam == null ? Collections.emptyList() : Arrays.asList(rowsParam);
        
        String[] childRowsParam = request.getParameterValues("childRows");
        List<String> childRows = childRowsParam == null ? new ArrayList<>() : new ArrayList<>(Arrays.asList(childRowsParam));
        
        String[] newOrderParam = request.getParameterValues("newOrder");
        List<String> newOrder = newOrderParam == null ? Collections.emptyList() : Arrays.asList(newOrderParam);
    ...
    private static View getView(HttpServletRequest request, String application, String module) {
