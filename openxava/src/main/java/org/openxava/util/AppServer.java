...
public class AppServer { 
	...
	public static void run(String app, String ... extraClassPaths) throws Exception { 
		...
		System.setProperty("tomcat.util.scan.StandardJarScanFilter.jarsToSkip", "accessors-smart-*.jar,activation-*.jar,antlr-*.jar,aopalliance-repackaged-*.jar,asm-*.jar,async-http-client-*.jar,auto-service-annotations-*.jar,bcprov-jdk15on-*.jar,byte-buddy-*.jar,castor-*.jar,checker-qual-*.jar,classmate-*.jar,commons-*.jar,content-type-*.jar,curvesapi-*.jar,dom4j-*.jar,dwr-*.jar,ecj-*.jar,ejb-api-*.jar,error_prone_annotations-*.jar,failsafe-*.jar,failureaccess-*.jar,FastInfoset-*.jar,fontbox-*.jar,groovy-*.jar,guava-*.jar,hamcrest-*.jar,hibernate-*.jar,hk2-*.jar,hsqldb-*.jar,htmlunit-*.jar,httpclient-*.jar,httpcore-*.jar,httpmime-*.jar,icu4j-*.jar,istack-commons-runtime-*.jar,itext-*.jar,j2objc-annotations-*.jar,jackson-*.jar,jakarta.activation-*.jar,jakarta.annotation-api-*.jar,jakarta.inject-*.jar,jakarta.json-*.jar,jakarta.json.bind-api-*.jar,jakarta.mail-*.jar,jakarta.validation-api-*.jar,jakarta.ws.rs-api-*.jar,jandex-*.jar,jasperreports-*.jar,javassist-*.jar,javax.activation-api-*.jar,javax.inject-*.jar,javax.mail-*.jar,javax.persistence-api-*.jar,jaxb-*.jar,jboss-logging-*.jar,jboss-transaction-*.jar,jcip-annotations-*.jar,jcommon-*.jar,jersey-*.jar,jetty-*.jar,jfreechart-*.jar,json-*.jar,jsoup-*.jar,jsr305-*.jar,junit-*.jar,lang-tag-*.jar,listenablefuture-*.jar,log4j-*.jar,lombok-*.jar,msal4j-*.jar,neko-htmlunit-*.jar,netty-*.jar,nimbus-jose-jwt-*.jar,oauth2-oidc-sdk-*.jar,openpdf-*.jar,opentelemetry-*.jar,osgi-resource-locator-*.jar,pdfbox-*.jar,poi-*.jar,reactive-streams-*.jar,selenium-*.jar,serializer-*.jar,slf4j-api-*.jar,SparseBitSet-*.jar,stax-*.jar,stax2-api-*.jar,tomcat-*.jar,txw2-*.jar,validation-api-*.jar,websocket-*.jar,woodstox-core-*.jar,xalan-*.jar,xercesImpl-*.jar,xml-apis-*.jar,xmlbeans-*.jar,yasson-*.jar");
