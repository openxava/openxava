...
public class Dashboard {
	...
	public Collection<PerYear> getEvolution() { 
		String jpql = "select new org.openxava.chattest.dashboards.PerYear(i.year, sum(i.total), sum(i.tax)) " +
			"from Invoice i " +
			"group by i.year " +
			"order by i.year asc";
	...
	public Collection<PerCustomer> getTopCustomers() { 
		String jpql = "select new org.openxava.chattest.dashboards.PerCustomer(i.customer.name, sum(i.total) as amount) " +
			"from Invoice i " +
	...
	public Collection<PerYear> getTopYears() { 
		String jpql = "select new org.openxava.chattest.dashboards.PerYear(i.year, sum(i.total) as amount, sum(i.tax)) " +
			"from Invoice i " +
			"group by i.year " +
			"order by amount desc";
