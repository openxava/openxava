...
while (it.hasNext()) {
	...
	if (!property.isCalculated()) {
		...
		// tmr boolean isTimestamp = property.isTypeOrStereotypeCompatibleWith(java.sql.Timestamp.class);  
		boolean isTimestamp = property.isCompatibleWith(java.sql.Timestamp.class); // tmr
