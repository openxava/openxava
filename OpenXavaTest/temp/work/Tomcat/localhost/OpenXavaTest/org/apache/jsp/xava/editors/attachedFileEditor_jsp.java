 ...
 * Generated at: 2019-09-05 12:37:01 UTC
...
if (!Is.emptyString(fvalue)) file = FilePersistorFactory.getInstance().find(fvalue);
 ...
 if(file != null) { 
      ...
      try {
        ...
        // /xava/editors/attachedFileEditor.jsp(35,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005faction_005f0.setAction("AttachedFile.delete");
        // /xava/editors/attachedFileEditor.jsp(35,4) name = argv type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      try {
        ...
        // /xava/editors/attachedFileEditor.jsp(37,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005faction_005f1.setAction("AttachedFile.choose");
        // /xava/editors/attachedFileEditor.jsp(37,4) name = argv type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
      ...
      try {
        ...
        // /xava/editors/attachedFileEditor.jsp(42,4) name = action type = null reqTime = true required = true fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
        _jspx_th_xava_005flink_005f0.setAction("AttachedFile.choose");
        // /xava/editors/attachedFileEditor.jsp(42,4) name = argv type = null reqTime = true required = false fragment = false deferredValue = false deferredMethod = false expectedTypeName = null methodSignature = null 
