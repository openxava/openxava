...
if (metaCollectionView != null) {
	...
	if (collectionView.getSaveCollectionElementAction().equals("Collection.save")) {
      ...
      out.write('\n');
      org.apache.jasper.runtime.JspRuntimeLibrary.include(request, response, "collectionEditor.jsp" + "?" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("listEditor", request.getCharacterEncoding())+ "=" + org.apache.jasper.runtime.JspRuntimeLibrary.URLEncode("treeViewListEditor.jsp", request.getCharacterEncoding()), out, false);
      out.write('\n');
