...
abstract public class WebDriverTestBase extends TestCase {
    ...
    public WebDriverTestBase(String testName) {
        super(testName);
    }
    ...
    protected void resetPreferences() throws Exception {
        ...
        driver.get("http://localhost:8080/chatvoice/xava/resetPreferences.jsp?zxy=HOljkso83");
    }
    ...
    protected void executeWithoutArg(String moduleName, String action) throws Exception {
        ...
        WebElement button = driver.findElement
                (By.id("ox_chatvoice_" + moduleName + "__" + actionS[0] + "___" + actionS[1]));
        button.click();
    ...
    protected void goModule(String module) throws Exception {
    	if (driver == null) driver = createWebDriver(getLang());
        driver.get("http://localhost:8080/chatvoice/m/" + module);
        acceptInDialogJS(driver);
        wait(driver);
        this.module = module;
        //this.driver = driver;
    ...
    protected String getDescriptionValue(String name) {		
        WebElement input = driver.findElement(By.name(Ids.decorate("chatvoice", module, name + "__DESCRIPTION__")));
    ...
    protected String getValue(String name) {
        WebElement input = driver.findElement(By.id(Ids.decorate("chatvoice", module, name)));
        return input.getAttribute("value");
    }
    ...
    protected void assertNoErrors() {
        WebElement errors = driver.findElement(By.id("ox_chatvoice_" + module + "__errors"));
    ...
    protected void clearListCondition() throws Exception{
        driver.findElement(By.id("ox_chatvoice_" +  module + "__xava_clear_condition")).click();
        wait(driver);
    }

    protected void setConditionValue(String value, int column) {
        driver.findElement(By.id("ox_chatvoice_" + module + "__conditionValue___" + String.valueOf(column))).sendKeys(value); 		
    }
    
    protected void setConditionComparator(String value, int column) throws Exception {
        WebElement selectCondition = driver.findElement(By.id("ox_chatvoice_" + module + "__conditionComparator___" + String.valueOf(column)));
