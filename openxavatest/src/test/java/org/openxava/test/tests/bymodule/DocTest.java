...
public class DocTest extends ModuleTestBase {
	...
	public void testHtmlTextToolTip_htmlTextInCharts_htmlTextWithQuoteAndGreaterThanSymbol() throws Exception { 
		...
		HtmlDivision div = (HtmlDivision) getHtmlPage().getByXPath("//div[@class='ox_openxavatest_Doc__tipable ox_openxavatest_Doc__list_col1 ox-list-default-column-width']").get(0);  
