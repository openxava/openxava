...
public class openxavatest {
	...
	public static void main(String[] args) throws Exception {
		...
		// tmr AppServer.run("openxavatest"); // Use AppServer.run("") to run in root context
		AppServer.run("openxavatest", "../openxava/target/classes"); // Use AppServer.run("") to run in root context // tmr
	}
